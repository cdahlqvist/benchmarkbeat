...
`${GOPATH}/src/github.com/cdahlqvist/benchmarkbeat`
...
```
git remote set-url origin https://github.com/cdahlqvist/benchmarkbeat
...
in the same directory with the name benchmarkbeat.
...
```
./benchmarkbeat -c benchmarkbeat.yml -e -d "*"
```
...
```
mkdir -p ${GOPATH}/src/github.com/cdahlqvist/benchmarkbeat
git clone https://github.com/cdahlqvist/benchmarkbeat ${GOPATH}/src/github.com/cdahlqvist/benchmarkbeat
```
